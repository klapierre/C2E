...
ggplot(data=subset(stdEst, lhs=='mean_change_transform'&rhs!=''&rhs!='anpp_PC_transform'&rhs!='mean_change_transform'), aes(x=treatment_year, y=std_alt)) +
  geom_point(size=3) +
  geom_errorbar(aes(ymin=std.all-se, ymax=std.all+se)) +
  geom_line(size=2) +
