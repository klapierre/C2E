...
###community data
correCommChange <- read.csv('corre_community differences_March2019.csv')%>%
  select(-treatment)%>%
...
correSEMdata <- correANPPchange%>%
  ...
  mutate(composition_diff_transform=sqrt(composition_diff), evenness_diff_transform=log10(as.numeric(evenness_diff+0.3)), anpp_PC_transform=log10(anpp_PC+1-min(anpp_PC)))
...
dataVis <- correSEMdata%>%
  select(anpp_PC_transform, composition_diff_transform, species_diff, evenness_diff_transform, rank_diff, richness_diff) #make visualization dataframe
...
#all yrs
ggplot(data=correSEMdataTrt, aes(x=treatment_year, y=anpp_PC_transform)) +
...
#10 yrs
ggplot(data=subset(correSEMdataTrt, treatment_year<11), aes(x=treatment_year, y=anpp_PC_transform)) +
  geom_smooth(method='lm', formula=y~x+I(x^2), se=F, aes(color=trt_type)) +
  geom_smooth(method='lm', formula=y~x+I(x^2), size=3, color='black') +
  xlab('Treatment Year') + ylab('log ANPP (%) Difference')
...
#with mean_change
anpp_mean_y1 <- ggplot(data=subset(correSEMdataTrt, treatment_year==1), aes(x=composition_diff_transform, y=anpp_PC_transform)) + 
  geom_point() +
  geom_smooth(method='lm', se=F) +
  ylab('ANPP Difference') + xlab('Community Difference') + ylim(0,0.7) + xlim(0,1)
anpp_mean_y2 <- ggplot(data=subset(correSEMdataTrt, treatment_year==2), aes(x=composition_diff_transform, y=anpp_PC_transform)) + 
  geom_point() +
  geom_smooth(method='lm', se=F) +
  ylab('ANPP Difference') + xlab('Community Difference') + ylim(0,0.7) + xlim(0,1)
anpp_mean_y3 <- ggplot(data=subset(correSEMdataTrt, treatment_year==3), aes(x=composition_diff_transform, y=anpp_PC_transform)) + 
  geom_point() +
  geom_smooth(method='lm', se=F) +
  ylab('ANPP Difference') + xlab('Community Difference') + ylim(0,0.7) + xlim(0,1)
anpp_mean_y4 <- ggplot(data=subset(correSEMdataTrt, treatment_year==4), aes(x=composition_diff_transform, y=anpp_PC_transform)) + 
  geom_point() +
  geom_smooth(method='lm', se=F) +
  ylab('ANPP Difference') + xlab('Community Difference') + ylim(0,0.7) + xlim(0,1)
anpp_mean_y5 <- ggplot(data=subset(correSEMdataTrt, treatment_year==5), aes(x=composition_diff_transform, y=anpp_PC_transform)) + 
  geom_point() +
  geom_smooth(method='lm', se=F) +
  ylab('ANPP Difference') + xlab('Community Difference') + ylim(0,0.7) + xlim(0,1)
anpp_mean_y6 <- ggplot(data=subset(correSEMdataTrt, treatment_year==6), aes(x=composition_diff_transform, y=anpp_PC_transform)) + 
  geom_point() +
  geom_smooth(method='lm', se=F) +
  ylab('ANPP Difference') + xlab('Community Difference') + ylim(0,0.7) + xlim(0,1)
anpp_mean_y7 <- ggplot(data=subset(correSEMdataTrt, treatment_year==7), aes(x=composition_diff_transform, y=anpp_PC_transform)) + 
  geom_point() +
  geom_smooth(method='lm', se=F) +
  ylab('ANPP Difference') + xlab('Community Difference') + ylim(0,0.7) + xlim(0,1)
anpp_mean_y8 <- ggplot(data=subset(correSEMdataTrt, treatment_year==8), aes(x=composition_diff_transform, y=anpp_PC_transform)) + 
  geom_point() +
  geom_smooth(method='lm', se=F) +
  ylab('ANPP Difference') + xlab('Community Difference') + ylim(0,0.7) + xlim(0,1)
anpp_mean_y9 <- ggplot(data=subset(correSEMdataTrt, treatment_year==9), aes(x=composition_diff_transform, y=anpp_PC_transform)) + 
  geom_point() +
  geom_smooth(method='lm', se=F) +
  ylab('ANPP Difference') + xlab('Community Difference') + ylim(0,0.7) + xlim(0,1)
anpp_mean_y10 <- ggplot(data=subset(correSEMdataTrt, treatment_year==10), aes(x=composition_diff_transform, y=anpp_PC_transform)) + 
  geom_point() +
  geom_smooth(method='lm', se=F) +
  ylab('ANPP Difference') + xlab('Community Difference') + ylim(0,0.7) + xlim(0,1)
#with N
...
#with mean_change
mean_rank_diff_y1 <- ggplot(data=subset(correSEMdataTrt, treatment_year==1), aes(x=rank_diff, y=composition_diff_transform)) + 
  geom_point() +
  geom_smooth(method='lm', se=F) +
  ylab('Community Difference') + xlab('rank_diff') + ylim(0,1) + xlim(0,0.41)
mean_rank_diff_y2 <- ggplot(data=subset(correSEMdataTrt, treatment_year==2), aes(x=rank_diff, y=composition_diff_transform)) + 
  geom_point() +
  geom_smooth(method='lm', se=F) +
  ylab('Community Difference') + xlab('rank_diff') + ylim(0,1) + xlim(0,0.41)
mean_rank_diff_y3 <- ggplot(data=subset(correSEMdataTrt, treatment_year==3), aes(x=rank_diff, y=composition_diff_transform)) + 
  geom_point() +
  geom_smooth(method='lm', se=F) +
  ylab('Community Difference') + xlab('rank_diff') + ylim(0,1) + xlim(0,0.41)
mean_rank_diff_y4 <- ggplot(data=subset(correSEMdataTrt, treatment_year==4), aes(x=rank_diff, y=composition_diff_transform)) + 
  geom_point() +
  geom_smooth(method='lm', se=F) +
  ylab('Community Difference') + xlab('rank_diff') + ylim(0,1) + xlim(0,0.41)
mean_rank_diff_y5 <- ggplot(data=subset(correSEMdataTrt, treatment_year==5), aes(x=rank_diff, y=composition_diff_transform)) + 
  geom_point() +
  geom_smooth(method='lm', se=F) +
  ylab('Community Difference') + xlab('rank_diff') + ylim(0,1) + xlim(0,0.41)
mean_rank_diff_y6 <- ggplot(data=subset(correSEMdataTrt, treatment_year==6), aes(x=rank_diff, y=composition_diff_transform)) + 
  geom_point() +
  geom_smooth(method='lm', se=F) +
  ylab('Community Difference') + xlab('rank_diff') + ylim(0,1) + xlim(0,0.41)
mean_rank_diff_y7 <- ggplot(data=subset(correSEMdataTrt, treatment_year==7), aes(x=rank_diff, y=composition_diff_transform)) + 
  geom_point() +
  geom_smooth(method='lm', se=F) +
  ylab('Community Difference') + xlab('rank_diff') + ylim(0,1) + xlim(0,0.41)
mean_rank_diff_y8 <- ggplot(data=subset(correSEMdataTrt, treatment_year==8), aes(x=rank_diff, y=composition_diff_transform)) + 
  geom_point() +
  geom_smooth(method='lm', se=F) +
  ylab('Community Difference') + xlab('rank_diff') + ylim(0,1) + xlim(0,0.41)
mean_rank_diff_y9 <- ggplot(data=subset(correSEMdataTrt, treatment_year==9), aes(x=rank_diff, y=composition_diff_transform)) + 
  geom_point() +
  geom_smooth(method='lm', se=F) +
  ylab('Community Difference') + xlab('rank_diff') + ylim(0,1) + xlim(0,0.41)
mean_rank_diff_y10 <- ggplot(data=subset(correSEMdataTrt, treatment_year==10), aes(x=rank_diff, y=composition_diff_transform)) + 
  geom_point() +
  geom_smooth(method='lm', se=F) +
  ylab('Community Difference') + xlab('rank_diff') + ylim(0,1) + xlim(0,0.41)
#with N
mean_n_y1 <- ggplot(data=subset(correSEMdataTrt, treatment_year==1), aes(x=n, y=composition_diff_transform)) + 
  geom_point() +
  geom_smooth(method='lm', se=F) +
  ylab('Community Difference') + xlab('N') + ylim(0,1) + xlim(0,60)
mean_n_y2 <- ggplot(data=subset(correSEMdataTrt, treatment_year==2), aes(x=n, y=composition_diff_transform)) + 
  geom_point() +
  geom_smooth(method='lm', se=F) +
  ylab('Community Difference') + xlab('N') + ylim(0,1) + xlim(0,60)
mean_n_y3 <- ggplot(data=subset(correSEMdataTrt, treatment_year==3), aes(x=n, y=composition_diff_transform)) + 
  geom_point() +
  geom_smooth(method='lm', se=F) +
  ylab('Community Difference') + xlab('N') + ylim(0,1) + xlim(0,60)
mean_n_y4 <- ggplot(data=subset(correSEMdataTrt, treatment_year==4), aes(x=n, y=composition_diff_transform)) + 
  geom_point() +
  geom_smooth(method='lm', se=F) +
  ylab('Community Difference') + xlab('N') + ylim(0,1) + xlim(0,60)
mean_n_y5 <- ggplot(data=subset(correSEMdataTrt, treatment_year==5), aes(x=n, y=composition_diff_transform)) + 
  geom_point() +
  geom_smooth(method='lm', se=F) +
  ylab('Community Difference') + xlab('N') + ylim(0,1) + xlim(0,60)
mean_n_y6 <- ggplot(data=subset(correSEMdataTrt, treatment_year==6), aes(x=n, y=composition_diff_transform)) + 
  geom_point() +
  geom_smooth(method='lm', se=F) +
  ylab('Community Difference') + xlab('N') + ylim(0,1) + xlim(0,60)
mean_n_y7 <- ggplot(data=subset(correSEMdataTrt, treatment_year==7), aes(x=n, y=composition_diff_transform)) + 
  geom_point() +
  geom_smooth(method='lm', se=F) +
  ylab('Community Difference') + xlab('N') + ylim(0,1) + xlim(0,60)
mean_n_y8 <- ggplot(data=subset(correSEMdataTrt, treatment_year==8), aes(x=n, y=composition_diff_transform)) + 
  geom_point() +
  geom_smooth(method='lm', se=F) +
  ylab('Community Difference') + xlab('N') + ylim(0,1) + xlim(0,60)
mean_n_y9 <- ggplot(data=subset(correSEMdataTrt, treatment_year==9), aes(x=n, y=composition_diff_transform)) + 
  geom_point() +
  geom_smooth(method='lm', se=F) +
  ylab('Community Difference') + xlab('N') + ylim(0,1) + xlim(0,60)
mean_n_y10 <- ggplot(data=subset(correSEMdataTrt, treatment_year==10), aes(x=n, y=composition_diff_transform)) + 
  geom_point() +
  geom_smooth(method='lm', se=F) +
  ylab('Community Difference') + xlab('N') + ylim(0,1) + xlim(0,60)

pushViewport(viewport(layout=grid.layout(10,2)))
print(mean_rank_diff_y1, vp=viewport(layout.pos.row = 1, layout.pos.col = 1))
print(mean_rank_diff_y2, vp=viewport(layout.pos.row = 2, layout.pos.col = 1))
print(mean_rank_diff_y3, vp=viewport(layout.pos.row = 3, layout.pos.col = 1))
print(mean_rank_diff_y4, vp=viewport(layout.pos.row = 4, layout.pos.col = 1))
print(mean_rank_diff_y5, vp=viewport(layout.pos.row = 5, layout.pos.col = 1))
print(mean_rank_diff_y6, vp=viewport(layout.pos.row = 6, layout.pos.col = 1))
print(mean_rank_diff_y7, vp=viewport(layout.pos.row = 7, layout.pos.col = 1))
print(mean_rank_diff_y8, vp=viewport(layout.pos.row = 8, layout.pos.col = 1))
print(mean_rank_diff_y9, vp=viewport(layout.pos.row = 9, layout.pos.col = 1))
print(mean_rank_diff_y10, vp=viewport(layout.pos.row = 10, layout.pos.col = 1))
...
#if we do 8 years only, then we can add in CO2

###composition model
#all years - does this make sense?
summary(compositionModelYr1 <- psem(
  lm(anpp_PC_transform ~ composition_diff_transform + n + p + irr + drought + treatment_year, data=correSEMdataTrt),
  lm(composition_diff_transform ~ n + p + irr + drought + treatment_year, data=correSEMdataTrt))
)


#year 1
summary(compositionModelYr1 <- psem(
  lm(anpp_PC_transform ~ composition_diff_transform + n + p + precip + treatment_year, data=correSEMdataTrt),
  lm(composition_diff_transform ~ n, data=correSEMdataTrt))
  )


summary(compositionModelYr1 <- psem(
  lm(anpp_PC_transform ~ composition_diff_transform + n + p + k, data=subset(correSEMdataTrt, treatment_year==1)),
  lm(composition_diff_transform ~ n + p + k, data=subset(correSEMdataTrt, treatment_year==1)))
)
...
#year 2
correModel2Fit <- sem(compositionModel, data=subset(correSEMdataTrt, treatment_year==2), meanstructure=TRUE)
...
#year 3
correModel3Fit <- sem(compositionModel, data=subset(correSEMdataTrt, treatment_year==3), meanstructure=TRUE)
...
#year 4
correModel4Fit <- sem(compositionModel, data=subset(correSEMdataTrt, treatment_year==4), meanstructure=TRUE)
...
#year 5
correModel5Fit <- sem(compositionModel, data=subset(correSEMdataTrt, treatment_year==5), meanstructure=TRUE)
...
#year 6
correModel6Fit <- sem(compositionModel, data=subset(correSEMdataTrt, treatment_year==6), meanstructure=TRUE)
...
#year 7
correModel7Fit <- sem(compositionModel, data=subset(correSEMdataTrt, treatment_year==7), meanstructure=TRUE)
...
#year 8
correModel8Fit <- sem(compositionModel, data=subset(correSEMdataTrt, treatment_year==8), meanstructure=TRUE)
...
#year 9
correModel9Fit <- sem(compositionModel, data=subset(correSEMdataTrt, treatment_year==9), meanstructure=TRUE)
...
#year 10
correModel10Fit <- sem(compositionModel, data=subset(correSEMdataTrt, treatment_year==10), meanstructure=TRUE)
...
stdEst <- rbind(stdEst1, stdEst2, stdEst3, stdEst4, stdEst5, stdEst6, stdEst7, stdEst8, stdEst9, stdEst10)%>%
  na.omit()%>%
  mutate(std_alt=ifelse(pvalue>0.1, 0, std.all), std_weighted=std.all/se, est_alt=ifelse(pvalue>0.1, 0, est), est_weighted=est/se, trt_alt=ifelse(rhs=='precip'|rhs=='k'|rhs=='n'|rhs=='other_trt'|rhs=='p', 'physiology', 'composition_diff_transform'))
...
ggplot(data=subset(stdEst, lhs=='composition_diff_transform'&rhs!=''&rhs!='anpp_PC_transform'&rhs!='composition_diff_transform'), aes(x=treatment_year, y=std.all)) +
  geom_point(size=3) +
...
# ggplot(data=subset(stdEst, lhs!='anpp_PC_transform'&lhs!='composition_diff_transform'&rhs!=''&rhs!='anpp_PC_transform'&rhs!='composition_diff_transform'&rhs!='species_diff'&rhs!='evenness_diff_transform'&rhs!='rank_diff'&rhs!='richness_diff'), aes(x=treatment_year, y=std.all, color=rhs)) +
#   geom_point(size=3) +
...
#   xlab('Treatment Year')
# 
# ggplot(data=subset(stdEstBin, lhs=='composition_diff_transform'&rhs!=''&rhs!='anpp_PC_transform'&rhs!='composition_diff_transform'), aes(x=temporal_bin, y=std.all_mean, color=rhs)) +
#   geom_bar(stat='identity', position=position_dodge()) +
#   geom_errorbar(aes(ymin=std.all_mean-(std.all_sd/sqrt(std.all_N)), ymax=std.all_mean+(std.all_sd/sqrt(std.all_N))), position=position_dodge(0.9), width=0.2) +
#   geom_line(size=3) +
#   ylab('Effect Size') +
#   xlab('Treatment Year')
# 
# ggplot(data=subset(stdEstBin, lhs!='anpp_PC_transform'&lhs!='composition_diff_transform'&rhs!=''&rhs!='anpp_PC_transform'&rhs!='composition_diff_transform'&rhs!='species_diff'&rhs!='evenness_diff_transform'&rhs!='rank_diff'&rhs!='richness_diff'), aes(x=temporal_bin, y=std.all_mean, color=rhs)) +
#   geom_bar(stat='identity', position=position_dodge()) +
#   geom_errorbar(aes(ymin=std.all_mean-(std.all_sd/sqrt(std.all_N)), ymax=std.all_mean+(std.all_sd/sqrt(std.all_N))), position=position_dodge(0.9), width=0.2) +
#   geom_line(size=3) +
#   facet_wrap(~lhs)
...
compModel10yr <-  '
anpp_PC_transform ~ composition_diff_transform + n + p + k + other_trt
composition_diff_transform ~ n + p + k + other_trt
'
#year 1
correModelFit <- sem(compModel10yr, data=subset(correSEMdataTrt10, treatment_year==1), meanstructure=TRUE)
...
#year 2
correModel2Fit <- sem(compModel10yr, data=subset(correSEMdataTrt10, treatment_year==2), meanstructure=TRUE)
...
#year 3
correModel3Fit <- sem(compModel10yr, data=subset(correSEMdataTrt10, treatment_year==3), meanstructure=TRUE)
...
#year 4
correModel4Fit <- sem(compModel10yr, data=subset(correSEMdataTrt10, treatment_year==4), meanstructure=TRUE)
...
#year 5
correModel5Fit <- sem(compModel10yr, data=subset(correSEMdataTrt10, treatment_year==5), meanstructure=TRUE)
...
#year 6
correModel6Fit <- sem(compModel10yr, data=subset(correSEMdataTrt10, treatment_year==6), meanstructure=TRUE)
...
#year 7
correModel7Fit <- sem(compModel10yr, data=subset(correSEMdataTrt10, treatment_year==7), meanstructure=TRUE)
...
#year 8
correModel8Fit <- sem(compModel10yr, data=subset(correSEMdataTrt10, treatment_year==8), meanstructure=TRUE)
...
#year 9
correModel9Fit <- sem(compModel10yr, data=subset(correSEMdataTrt10, treatment_year==9), meanstructure=TRUE)
...
#year 10
correModel10Fit <- sem(compModel10yr, data=subset(correSEMdataTrt10, treatment_year==10), meanstructure=TRUE)
...
# ggplot(data=subset(stdEst, lhs!='anpp_PC_transform'&lhs!='composition_diff_transform'&rhs!=''&rhs!='anpp_PC_transform'&rhs!='composition_diff_transform'&rhs!='rank_diff'&rhs!='evenness_diff_transform'&rhs!='species_diff'&rhs!='richness_diff'), aes(x=treatment_year, y=std.all, color=rhs)) +
#   geom_point(size=3) +
#   geom_line(size=2) +
...
#if we do 8 years only, then we can add in CO2
sersModel <-  '
anpp_PC_transform ~ evenness_diff_transform + rank_diff + species_diff + richness_diff + n + p + k + precip + other_trt
evenness_diff_transform ~ n + p + k + precip + other_trt
rank_diff ~ n + p + k + precip + other_trt
species_diff ~ n + p + k + precip + other_trt
richness_diff ~ n + p + k + precip + other_trt

#covariances
evenness_diff_transform~~rank_diff
evenness_diff_transform~~species_diff
evenness_diff_transform~~richness_diff
rank_diff~~species_diff
rank_diff~~richness_diff
richness_diff~~species_diff
'
#year 1
correModelFit <- sem(sersModel, data=subset(correSEMdataTrt, treatment_year==1), meanstructure=TRUE)
surveyDesign <- svydesign(ids=~site_project_comm, nest=TRUE, data=subset(correSEMdataTrt, treatment_year==1))
survey1Fit <- lavaan.survey(lavaan.fit=correModelFit, survey.design=surveyDesign)
survey1Fit  #gives chi-square
# summary(survey1Fit, fit.measures=TRUE, rsq=TRUE, standardized=TRUE)
...
#year 2
correModel2Fit <- sem(sersModel, data=subset(correSEMdataTrt, treatment_year==2), meanstructure=TRUE)
surveyDesign <- svydesign(ids=~site_project_comm, nest=TRUE, data=subset(correSEMdataTrt, treatment_year==2))
survey2Fit <- lavaan.survey(lavaan.fit=correModel2Fit, survey.design=surveyDesign)
survey2Fit  #gives chi-square
# summary(survey2Fit, fit.measures=TRUE, rsq=TRUE, standardized=TRUE)
...
#year 3
correModel3Fit <- sem(sersModel, data=subset(correSEMdataTrt, treatment_year==3), meanstructure=TRUE)
surveyDesign <- svydesign(ids=~site_project_comm, nest=TRUE, data=subset(correSEMdataTrt, treatment_year==3))
survey3Fit <- lavaan.survey(lavaan.fit=correModel3Fit, survey.design=surveyDesign)
survey3Fit  #gives chi-square
# summary(survey3Fit, fit.measures=TRUE, rsq=TRUE, standardized=TRUE)
...
#year 4
correModel4Fit <- sem(sersModel, data=subset(correSEMdataTrt, treatment_year==4), meanstructure=TRUE)
surveyDesign <- svydesign(ids=~site_project_comm, nest=TRUE, data=subset(correSEMdataTrt, treatment_year==4))
survey4Fit <- lavaan.survey(lavaan.fit=correModel4Fit, survey.design=surveyDesign)
survey4Fit  #gives chi-square
# summary(survey4Fit, fit.measures=TRUE, rsq=TRUE, standardized=TRUE)
...
#year 5
correModel5Fit <- sem(sersModel, data=subset(correSEMdataTrt, treatment_year==5), meanstructure=TRUE)
surveyDesign <- svydesign(ids=~site_project_comm, nest=TRUE, data=subset(correSEMdataTrt, treatment_year==5))
survey5Fit <- lavaan.survey(lavaan.fit=correModel5Fit, survey.design=surveyDesign)
survey5Fit  #gives chi-square
# summary(survey5Fit, fit.measures=TRUE, rsq=TRUE, standardized=TRUE)
...
#year 6
correModel6Fit <- sem(sersModel, data=subset(correSEMdataTrt, treatment_year==6), meanstructure=TRUE)
surveyDesign <- svydesign(ids=~site_project_comm, nest=TRUE, data=subset(correSEMdataTrt, treatment_year==6))
survey6Fit <- lavaan.survey(lavaan.fit=correModel6Fit, survey.design=surveyDesign)
survey6Fit  #gives chi-square
# summary(survey6Fit, fit.measures=TRUE, rsq=TRUE, standardized=TRUE)
...
#year 7
correModel7Fit <- sem(sersModel, data=subset(correSEMdataTrt, treatment_year==7), meanstructure=TRUE)
surveyDesign <- svydesign(ids=~site_project_comm, nest=TRUE, data=subset(correSEMdataTrt, treatment_year==7))
survey7Fit <- lavaan.survey(lavaan.fit=correModel7Fit, survey.design=surveyDesign)
survey7Fit  #gives chi-square
# summary(survey7Fit, fit.measures=TRUE, rsq=TRUE, standardized=TRUE)
...
#year 8
correModel8Fit <- sem(sersModel, data=subset(correSEMdataTrt, treatment_year==8), meanstructure=TRUE)
surveyDesign <- svydesign(ids=~site_project_comm, nest=TRUE, data=subset(correSEMdataTrt, treatment_year==8))
survey8Fit <- lavaan.survey(lavaan.fit=correModel8Fit, survey.design=surveyDesign)
survey8Fit  #gives chi-square
# summary(survey8Fit, fit.measures=TRUE, rsq=TRUE, standardized=TRUE)
...
#year 9
correModel9Fit <- sem(sersModel, data=subset(correSEMdataTrt, treatment_year==9), meanstructure=TRUE)
surveyDesign <- svydesign(ids=~site_project_comm, nest=TRUE, data=subset(correSEMdataTrt, treatment_year==9))
survey9Fit <- lavaan.survey(lavaan.fit=correModel9Fit, survey.design=surveyDesign)
survey9Fit  #gives chi-square
# summary(survey9Fit, fit.measures=TRUE, rsq=TRUE, standardized=TRUE)
...
#year 10
correModel10Fit <- sem(sersModel, data=subset(correSEMdataTrt, treatment_year==10), meanstructure=TRUE)
surveyDesign <- svydesign(ids=~site_project_comm, nest=TRUE, data=subset(correSEMdataTrt, treatment_year==10))
survey10Fit <- lavaan.survey(lavaan.fit=correModel10Fit, survey.design=surveyDesign)
survey10Fit  #gives chi-square
# summary(survey10Fit, fit.measures=TRUE, rsq=TRUE, standardized=TRUE)
